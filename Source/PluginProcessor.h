...
class BandpassFilterAudioProcessor  : public juce::AudioProcessor
{
public:
    BandpassFilterAudioProcessor();
    ~BandpassFilterAudioProcessor() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (BandpassFilterAudioProcessor)
};